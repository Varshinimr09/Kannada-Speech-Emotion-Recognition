      ...
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-center">
        ...
        >
          ...
          <p className="text-lg text-gray-300 mb-8">
            Analyze Kannada speech emotions with advanced AI technology. Login to access your dashboard and start detecting emotions from speech audio.
          </p>
          <div className="space-y-4">
            {[
              { icon: 'ri-mic-line', text: 'Real-time emotion detection' },
              { icon: 'ri-bar-chart-box-line', text: 'Advanced analytics dashboard' },
              { icon: 'ri-shield-check-line', text: 'Secure and private' }
            ].map((feature, index) => (
        ...
        >
          <div className="mb-8">
            <h2 className="text-3xl font-display font-bold text-navy mb-2">Sign In</h2>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/register" className="text-primary hover:text-primary-dark font-semibold cursor-pointer">
                Create Account
              </Link>
            </p>
          </div>
